...
var _iconsSvg = require("url:../img/icons.svg"); //parcel 2 for importing non js file
...
const showRecipe = async function() {
    try {
        const id = window.location.hash.slice(1); // for slice the hash at started like #5788393=5788393
        console.log(id);
        ...
        if (!res.ok) throw new Error(`Can't get your recipes ${data.message} ${res.status}`);
...
// showRecipe();
//for when user select some specific
[
    'hashchange',
    'load'
